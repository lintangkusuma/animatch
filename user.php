	...
	<div id="profil" style="background: url(img/gambars/user.png) center no-repeat; height: 650px; background-size: 500px; color: #fbeccf">
		<center>
			...
			<div id="data" style="width: 330px;height: 70px;">
				...
				if ($data['SUM(score)'] == NULL) {
					echo "<h2 style='font-size: 15px; margin-top: -58px; text-align: right'>Total Score : 0</h2>";
				} else {
			...
			<div id="back" style="background: url(img/gambars/back.png) center no-repeat; width: 100px; height: 100px; background-size: 100px; margin-top: 40px;margin-left: 7px;" onClick="window.location='account.php'"></div>
		</center>
	</div>
</body>
</html>